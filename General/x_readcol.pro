pro x_readcol,name,v1,v2,v3,v4,v5,v6,v7,v8,v9,v10,v11,v12,v13,v14,v15, $
              v16,v17,v18,v19,v20,v21,v22,v23,v24,v25,v26,v27,v28,v29,v30,$
              v31,v32,v33,v34,v35,v36,v37,v38,v39,v40,v41,v42,v43,$
              COMMENT = comment, $
              FORMAT = fmt, DEBUG=debug, SILENT=silent, SKIPLINE = skipline, $
              NUMLINE = numline, DELIMITER = delimiter, REGEX=regex
;+
; NAME:
;       READCOL
; PURPOSE:
...
;-
  ...
  if N_params() lt 2 then begin
     print,'Syntax - READCOL, name, v1, [ v2, v3,...v35, '
...
;          tst = execute(vv[k] + '= make_array(nlines,TYPE = idltype[i] )' ) 
   ...
   for j = 0L, nlines-1 do begin
    ...
    var = strsplit(strcompress(temp),delimiter,/extract, /preserve_null, REGEX=regex) 
