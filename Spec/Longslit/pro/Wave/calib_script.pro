...
wave_savefile='/Users/cleibler/Documents/DataReduction/lris/2015apr/mask_J1211_c4/Blue/wave-b150420_4026_old.sav'
iref = 7
restore, wavesave_file
...
x_identify, arc1d[*, slit-1L], calib_temp $
            ...
            '/Spec/Arcs/Lists/lris_blue_1200.lst' $
            , pkwdth = pkwdth $
...
spawn, 'mv ' + getenv('LONGSLIT_DIR') + $
       '/calib/linelists/lris_blue_1200.sav  ' $
       +  getenv('LONGSLIT_DIR') + $
       '/calib/linelists/lris_blue_1200_old.sav'  
