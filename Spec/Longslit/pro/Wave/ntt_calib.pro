pkwdth = 3.0
TOLER = 1.5 ;;slit/2.0D ;; tolerance for the line centers, use this value???
...
fweight = 0 ;; Use flux weighted centroiding 
restore, '/Users/joe/IDL/xidl/Spec/Longslit/calib/linelists/NTT_EFOSC_G11.sav'

dims=size(archive_arc,/dim)
ny = dims[0]
nyby2 = ny/2L

linelist = getenv('XIDL_DIR')+'/Spec/Arcs/Lists/oh_linelist.lst' 
x_identify, archive_arc, calib_temp, xsize = 1500, ysize = 900 $
