...
;     aper    = obj_str[q].aper > base_aper
      ...
      ;;  Lets fit vs. alog10(wavelengths) if possible
...
;
      ...
      For I_TRC=0, FIN_TRC do begin
         ...
         if keyword_set(OUTMASK_EX) and I_TRC EQ 0 then delvarx, outmask_ex
          ...
          ;;      in units of arcseconds (thats the 5. for MIKE)
          ;;
...
;            < ordr_shift[q].rhedg
          ...
          ;; Smooth the box car extraction and identify CRs
...
;     print, 'chi = ', median(chi_pix), mean(chi_pix)
     ...
     if keyword_set(FORCE_BLZ) then begin
