...
;pro wfccd_chkspec_icmmn

;

;common wfccd_chkspec_cmm, $
;  objstr
...
pro wfccd_chkspec, wfccd, mask_id, expsr, XSIZE=xsize, YSIZE=ysize, $
                   PRINTONLY=printonly
...
;  Object Structure
  wfobj = mrdfits(wfccd[exp].obj_fil, 1, STRUCTYP='specobjstrct', /silent)
  objstr = wfobj[where(wfobj.flg_anly NE 0, nobj)]
...
;    WIDGET
  base = WIDGET_BASE( title = 'wfccd_chkspec: Check spectra', /column, $
...
;        Version + Name + trace
  labelbase = widget_base(toolbar, /column, /base_align_center, /frame, $
                          /align_center)
  namelabel = WIDGET_LABEL(labelbase, value='wfccd_chkspec', /align_center)
