...
; CALLING SEQUENCE:
;   
;  mage_echfndobj, esi, obj_id, [exp], REFWV=, SCICLM=, PEAKTHRESH=,
...
;
; EXAMPLES:
;   mage_echfndobj, img_minsky, sciivar, waveimg, tset_slits, /CHK
;
...
FUNCTION mage_findobj, img_minsky,sciivar,waveimg,tset_slits $
...
;;  Optional Keywords
  if not KEYWORD_SET(NORDERS) THEN NORDERS=15
  ...
  objstruct = mage_echjoefind(img_minsky, sciivar*(ordermask GT 0) $
