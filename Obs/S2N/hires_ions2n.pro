...
;   12-Oct-2011 GDW     v1.2    Added XIDL_DIR envar
;-
;------------------------------------------------------------------------------

pro hires_ions2n, plottype, binning, exptime, mag, slitwidth, seeing, $
                  airmass, moondays, minwave, maxwave, deltawave, $
                  XSIZE=xsize,  YSIZE=ysize, SLIT_THRU=slit_thru, RESOLU=resolu, $
                  TABLE=table
  ...
  ;; Initialize
  x_inithires, str_instr, 2, INFIL=infil, STR_TEL=str_tel, DECKER=decker
  ...
  ;; GDW 2011-Oct-12 changed resolution computation per instructions
  ;; from Xavier.
  ...
  ;; Calc
  hires_calcs2n, state.wave[0:state.nwv-1], 2, $
