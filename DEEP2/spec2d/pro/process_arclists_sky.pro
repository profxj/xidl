function process_arclists_sky,arcnames,lampfilename,grating,anamorph,depth=depth
...
; in the 1200-line grating	
  ...
  for i = 0, narc-1 do begin
    ...
    ;if the lamps are off lest assume this is a sky frame
    elementtmp = strsplit(lampstmp, /extract)
 
    if n_elements(elementtmp) eq 1 then begin
        if elementtmp eq 'Off' then begin
            lampstmp = 'Sky'
        endif
    endif
