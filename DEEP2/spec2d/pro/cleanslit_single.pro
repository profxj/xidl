...
pro cleanslit_single, refslit, planfile,chiplist=chiplist, nlsky=nlsky
...
; combine multiple exposures
  ...
  refslitfile='spSlit.' + maskname + '.' + refslit + '.fits'

  shifts=find_dither_offsets_single(refslitfile,Nexp[0])
