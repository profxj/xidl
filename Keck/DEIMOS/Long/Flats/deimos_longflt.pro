...
;
; CALLING SEQUENCE:
;  deimos_longflt, flatfil, nrmflat, FITS=, GAIN=, /NOFIT, /FULL
;
; INPUTS:
...
pro deimos_longflt, flatfil, nrmflat, FITS=fits, GAIN=gain, $
                   NOFIT=nofit, FULL=full

;
  if  N_params() LT 2  then begin 
      print,'Syntax - ' + $
        'deimos_longflt, img, nnmflt, FITS= '
      return
  endif 
