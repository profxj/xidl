; $Id: x_gaussfit.pro,v 1.2 2008-01-17 23:18:19 xavier Exp $
;
...
Function x_Gaussfit, x, y, a, $
    ...
    yfit = x_CURVEFIT(x,y,weights,a,sigma, $
        CHISQ=chisq, YERROR=yerror, COVAR=covar, $
        FUNCTION_NAME = "X_GAUSS_FUNCT", STATUS=status) ;call curvefit
