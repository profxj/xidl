...
pro extlwd_05aug02, esi, obj_id, expsr, FNDOBJ=fndobj, EXTRCT=extrct,  $
                    ...
                    TRCCHK=trcchk, TRCOBJ=trcobj, FORCE=force

;;
  if  N_params() LT 2  then begin 
      print,'Syntax - ' + $
        'extlwdf_05aug02, esi, obj_id, /MKOBJ, /EXTRCT, /MKALL, /SKYSUB, '
  ...
  if keyword_set( TRCOBJ ) then begin
      esi_lwdtrcobj, esi, obj_id, /STD, CHK=trcchk
      ;; Write
      esi_wrstrct, esi, FITS='esi_05aug02.fits'
  endif
