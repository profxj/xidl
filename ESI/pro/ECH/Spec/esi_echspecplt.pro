...
pro esi_echspecplt_Reset, state
...
pro esi_echspecplt, spec_fil, obj_id, XSIZE=xsize, YSIZE=ysize, $
                ...
                BLOCK=block, ZIN=zin, NRM=nrm, FSPEC=fspec
