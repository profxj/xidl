...
;
; PURPOSE:
;  Routine used to check the ESI pipeline.  For internal use only.
;
; CALLING SEQUENCE:
;
; INPUTS:
...
;------------------------------------------------------------------------------
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
pro esi_tstrdx, OUTDIR, SKIP_SNGL=skip_sngl, SKIP_MULTI=skip_multi, SKIP_ARC=skip_arc, $
...
if not keyword_set(OUTDIR) then outdir = 'OUTPUT/'
file_mkdir, OUTDIR
