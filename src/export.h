...
#define darwin_ppc
#endif
      /* Added RJC - Princeton Feb 17, 2009 to allow 64bit Mac */
#ifdef __x86_64__
 ...
 * known independently.
 */
#if defined(ALPHA_OSF) || defined(SUN_64) || defined(LINUX_X86_64) || defined(HPUX_64) || defined(IRIX_64) || defined(AIX_64) || defined(DARWIN_X86_64)
